...
public class util {
    ...
    static public void share(String packageName, Context context, String content) {
        ...
        startActivity(Intent.createChooser(intent, context.getString(R.string.share_with)), true,
                context);
    }
    ...
    static public void feedBack(Context context) {
        ...
        intent.setData(Uri.fromParts("mailto", context.getString(R.string.browser_author), null));
        startActivity(intent, true, context);
    }
    ...
    static public boolean startActivity(Intent intent, boolean showToast, Context context) {
        ...
        try {
            ...
            if (showToast)
                try {
                    AlertDialog dlg = new AlertDialog.Builder(context).setMessage(e.toString())
    ...
    static public boolean startApp(ResolveInfo info, Context context) {
        if (info == null) {
            try {
                ...
                Toast.makeText(context, "null pointer error of resolveInfo", Toast.LENGTH_LONG)
                        .show();
            }
            return false;
        }
     ...
     */
    static public Bitmap generatorCountIcon(Bitmap icon, int count, int scheme, float density,
            Context context) {
        // init canvas
